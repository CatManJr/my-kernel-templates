...
from .adapters import (
    get_flashattention_autograd_function_triton_all,
)
...
def test_flash_forward_pass_triton(is_causal):
    _test_flash_forward_pass(get_flashattention_autograd_function_triton_all().apply, device="cuda", is_causal=is_causal)
...
def test_flash_backward_triton(is_causal):
    ...
    get_flashattention_autograd_function_triton_all().apply(q, k, v, is_causal).backward(do)
